<template>
  <div class="login-container">
    <!-- <img src="/img/login/car.png" class="car-img" alt=""> -->
    ...
    <div class="login-weaper">
      ...
      <div class="login-border animated bounceInDown">
    ...
    <div class="login-copyright">
      <!-- {{ website.copyright}} -->
      <span>Copyright © 2021 <a class="websit-url" href="https://www.weiwopark.com" target="_blank">帷幄科技</a> All rights reserved.</span>
    </div>
